                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $student->enroll_number; ?>" name="enroll_number" id="enroll_number" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="date_of_admission">Date of Admission:</label>
                                    <input type="text" value="<?= $student->date_of_admission; ?>" name="date_of_admission" id="date_of_admission" class="form-control">
                                </div>
